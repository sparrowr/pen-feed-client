...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://evening-falls-18430.herokuapp.com',
...
var onCreatePen = function onCreatePen(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var penData = logic.storePen(data);
  api.createPen(penData).then(ui.createPenSuccess).then(function () {
    return onGetPens(event);
  }).catch(ui.createPenFailure);
};

var autoGetPens = function autoGetPens() {
  api.getPens().then(logic.displayPens).then(ui.getPensSuccess).catch(ui.getPensFailure);
};

var onGetPens = function onGetPens(event) {
  event.preventDefault();
  autoGetPens();
};

var onUpdatePens = function onUpdatePens(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var penId = $(event.target).data('id');
  var penData = logic.storePen(data);
  api.updatePens(penData, penId).then(ui.getUpdatePenSuccess(penId)).then(function () {
    return onGetPens(event);
  }).catch(ui.getUpdatePenFailure);
};

var onDeletePen = function onDeletePen(event) {
  event.preventDefault();
  var penId = $(event.target).data('id');
  api.deletePen(penId).then(ui.getDeletePenSuccess(penId)).then(function () {
    return onGetPens(event);
...
var clearStatus = setTimeout(function () {
  $('.status').text('');
}, duration);

// destroy and recreate the status hiding timeout every time a new thing happens
var resetClearStatus = function resetClearStatus() {
...
module.exports = {
  resetClearStatus: resetClearStatus
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var penEvents = __webpack_require__(6);

$(function () {
  authEvents.addHandlers();
  penEvents.addHandlers();
});
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var createPen = function createPen(data) {
...
var updatePens = function updatePens(data, penId) {
  return $.ajax({
...
var deletePen = function deletePen(penId) {
  return $.ajax({
    url: config.apiUrl + '/pens/' + penId,
    method: 'DELETE',
    headers: {
...
var showPensTemplate = __webpack_require__(18);
var status = __webpack_require__(8);

var createPenSuccess = function createPenSuccess() {
...
var createPenFailure = function createPenFailure() {
  $('.createPenMessage').text('Failed to create pen! Please try again');
  status.resetClearStatus();
};

var getPensSuccess = function getPensSuccess(pens) {
  var getPensHTML = showPensTemplate({ pens: pens });
...
var getPensFailure = function getPensFailure() {
  $('.status').text('Failed to retrieve pens. No pens were found.');
  status.resetClearStatus();
};

var getUpdatePenSuccess = function getUpdatePenSuccess(penId) {
  $('.status').text('You have successfully updated a pen!');
  status.resetClearStatus();
  var modalName = '#updateModal' + penId;
  $(modalName).modal('toggle');
  $('input[type=text]').val('');
};

var getUpdatePenFailure = function getUpdatePenFailure() {
  $('.status').text('Failed to update pen. Something has gone wrong.');
  status.resetClearStatus();
};

var getDeletePenSuccess = function getDeletePenSuccess(penId) {
  $('.status').text('You have successfully deleted a pen!');
  status.resetClearStatus();
  var modalName = '#removeModal' + penId;
  $(modalName).modal('toggle');
};

var getDeletePenFailure = function getDeletePenFailure() {
  $('.status').text('Failed to delete pen. Something has gone wrong.');
  status.resetClearStatus();
};

module.exports = {
  createPenSuccess: createPenSuccess,
  createPenFailure: createPenFailure,
  getPensSuccess: getPensSuccess,
  getPensFailure: getPensFailure,
  getUpdatePenSuccess: getUpdatePenSuccess,
  getUpdatePenFailure: getUpdatePenFailure,
  getDeletePenSuccess: getDeletePenSuccess,
  getDeletePenFailure: getDeletePenFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div>\n  <div class=\"pen-info\">\n  <h1 data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"list-unstyled\">\n    <li>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cleaningMessage : stack1), depth0))
    + "</li>\n    <li>Days since last update: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.daysSinceUpdate : stack1), depth0))
    + "</li>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.inkType : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.inkName : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  <small>Pen ID:"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "</small>\n  <br>\n</ul>\n    <!-- update button -->\n    <input type=\"button\" class=\"btn btn-cyan\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" data-toggle=\"modal\" data-target=\"#updateModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"Update\" value=\"Update\">\n</div>\n    <!--Begin Update Modal -->\n    <div class=\"modal\" id=\"updateModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\"  tabindex=\"-1\" role=\"dialog\">\n      <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n            <h4 class=\"modal-title\">Update Pen</h4>\n          </div>\n        <div class=\"modal-body\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n          <form class=\"update-pen\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n            <label for=\"penNameField"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Pen Name:</label>\n            <input type=\"text\" name=\"pen[name]\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\" id=\"penNameField"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n            <br>\n            <div class=\"form-check form-check-inline\">\n                <input class=\"form-check-input\" type=\"checkbox\" id=\"inkedCheckBox"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"pen[isInked]\">\n                <label class=\"form-check-label\" for=\"inkedCheckBox"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Inked</label>\n                <input class=\"form-check-input\" type=\"checkbox\" id=\"cleanedCheckBox"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"pen[isClean]\">\n                <label class=\"form-check-label\" for=\"cleanedCheckBox"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Cleaned</label>\n            </div>\n            <br>\n            <label for=\"inkNameField"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Ink Name:</label>\n            <input type=\"text\" name=\"pen[inkName]\" placeholder=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.inkName : stack1), depth0))
    + "\" id=\"inkNameField"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n            <br>\n            <label for=\"changedOnSelector"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Pen inked or cleaned on:</label>\n            <input type=\"date\" id=\"changedOnSelector"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"pen[changedOn]\" pattern=\"[0-9]{4}-[0-9]{2}-[0-9]{2}\">\n            <br>\n            <label for=\"inkTypeSelector"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Ink type:</label>\n              <select multiple class=\"form-control\" id=\"inkTypeSelector"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"pen[inkType]\">\n                <!-- value=\"pen[inkType]\" -->\n                <option>Empty</option>\n                <option>Water-Soluble</option>\n                <option>Bulletproof</option>\n                <option>Waterproof</option>\n                <option>Shimmer</option>\n              </select>\n            <input type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"btn btn-cyan\" name=\"submit\" value=\"Update Pen\">\n          </form>\n        </div>\n      <div class=\"modal-footer\">\n\n      </div>\n    </div>\n  </div>\n</div>\n<!--End of Update Modal   -->\n<div class=\"pen-info\">\n  <input type=\"button\" class=\"btn btn-sand\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\"\n  data-toggle=\"modal\" data-target=\"#removeModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"Remove\" value=\"Remove\">\n</div>\n<!--Begin Remove Modal -->\n<div class=\"modal\" id=\"removeModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\"  tabindex=\"-1\" role=\"dialog\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n        <h4 class=\"modal-title\">Really remove "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "?</h4>\n      </div>\n    <div class=\"modal-body\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n      <p>This pen's information will be destroyed.</p>\n      <form class=\"remove-pen\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n        <input type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"btn btn-cyan\" name=\"submit\" value=\"Remove Pen\">\n      </form>\n    </div>\n  <div class=\"modal-footer\">\n\n  </div>\n</div>\n</div>\n</div>\n<!-- End Removal Modal -->\n<hr>\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "      <li>Ink Type: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.inkType : stack1), depth0))
    + "</li>\n";
},"4":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "      <li>Ink Name: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.inkName : stack1), depth0))
    + "</li>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.pens : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
};var addCleaningPriority = function addCleaningPriority(pen) {
  // if this has an invalid or unrecorded ink type and is not clean
  // default to water-soluble ink
  var cleanAfter = cleanIntervals['Water-Soluble'];
...
var addStatusInfo = function addStatusInfo(pen) {
  // JavaScript months are zero-indexed
  var dateOfChange = new Date(pen.changedYear, pen.changedMonth - 1, pen.changedDay);
...
var mostRecentPen = function mostRecentPen(penA, penB) {
...
var comparePens = function comparePens(penA, penB) {
...
var storePen = function storePen(data) {
...
var displayPens = function displayPens(data) {
